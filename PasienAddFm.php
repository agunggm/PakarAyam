...
<form action="?page=daftarsim" method="post" name="form1" target="_self">
  <table width="400" border="0" cellpadding="2" cellspacing="1" bgcolor="#DBEAF5">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td>Nama</td>
      <td> 
        <input name="TxtNama" type="text" value="<?= $TxtNama; ?>" size="35" maxlength="60"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td>Kelamin</td>
      <td> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td>Alamat</td>
      <td> 
        <input name="TxtAlamat" type="text" value="<?= $TxtAlamat; ?>" size="35" maxlength="60"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="76">Pekerjaan</td>
      <td width="312"> 
        <input name="TxtPekerjaan" type="text" value="<?= $TxtPekerjaan; ?>" size="35" maxlength="60"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td>&nbsp;</td>
      <td> 
